        ...
        <div style="background-color:#000000;" data-p="610">
            ...
            <div data-ts="flat" data-p="1618" data-po="50% -100%" style="left:120px;top:90px;width:509px;height:300px;position:absolute;">
                <svg viewbox="0 0 380 200" data-to="50% 50%" width="380" height="200" data-t="9" style="left:-74px;top:72px;display:block;position:absolute;opacity:0;overflow:visible;">
                    <g>
                        <text fill="#ffffff" x="-4" y="2" style="position:absolute;mix-blend-mode:darken;font-family:Montserrat,sans-serif;font-size:32px;font-weight:500;letter-spacing:0.1em;overflow:visible;">Zapewniamy&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                        </text>
                        <text fill="#ffffff" text-anchor="middle" x="198" y="100" style="position:absolute;font-family:Montserrat,sans-serif;font-size:32px;font-weight:500;overflow:visible;">profesjonalne wykonanie
                        </text>
                        <text fill="#f7f8fa" text-anchor="start" x="-8" y="150" style="position:absolute;font-family:Montserrat,sans-serif;font-size:32px;font-weight:500;letter-spacing:0.1em;overflow:visible;">dla klientów indywidualnych,&nbsp;
                        </text>
                        <text fill="#faf8f7" x="-6" y="198" style="position:absolute;opacity:0.8;font-family:Montserrat,sans-serif;font-size:32px;font-weight:500;letter-spacing:0.1em;overflow:visible;">również podwykonawstwo
                        </text>
                    </g>
                </svg>
            </div>
            <div data-ts="preserve-3d" style="left:338px;top:355px;width:300px;height:150px;position:absolute;">
                <svg viewbox="0 0 200 40" data-to="50% 50%" width="200" height="40" data-t="10" style="left:50px;top:500px;display:block;position:absolute;font-family:Roboto,sans-serif;font-size:18px;font-weight:800;overflow:visible;">
