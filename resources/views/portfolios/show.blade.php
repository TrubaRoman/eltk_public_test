                                    ...
                                    <div class="ttm-pf-detailbox">
                                        <ul class="ttm-pf-detailbox-list">
                                            <li class="ttm-pf-details-date">
                                                ...
                                                <span class="ttm-pf-left-details">{{__('content/pages.portfolio.project_name')}} </span>
                                                <span class="ttm-pf-right-details">{{$portfolio_item->project_name}}</span>
                                            </li>
                                            <li class="ttm-pf-details-date">
                                                <i class="fa fa-user"></i>
                                                <span class="ttm-pf-left-details">{{__('content/pages.portfolio.client')}} </span>
...
{{--                                            </li>--}}
                                            <li class="ttm-pf-details-date">
                                                ...
                                                <span class="ttm-pf-left-details">{{__('content/pages.portfolio.date')}} </span>
...
{{--                                            </li>--}}
                                            <li class="ttm-pf-details-date">
                                                ...
                                                <span class="ttm-pf-left-details">{{__('content/pages.portfolio.location')}} </span>
